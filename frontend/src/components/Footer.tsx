...
const Footer = () => {
  return (
    <div className="bg-[#fafafa] flex flex-col p-12">
      <div className="mt-5 flex justify-evenly border-b pb-14">
        <div className="w-[260px] p-2">
          <div>
            <img className="w-28 h-10" src="/DF.png" alt="" />
          </div>
          ...
          <div className="mt-4 flex justify-start">
            ...
            <FontAwesomeIcon icon={faFacebookSquare} className="ml-4" />
            <FontAwesomeIcon icon={faInstagram} className="ml-4" />
            <FontAwesomeIcon icon={faPinterest} className="ml-4" />
          </div>
        </div>
        <div className="p-2">
      ...
      <div className=" mt-14 flex justify-between">
        <div className=" flex items-center">
          ...
          <span className="text-sm text-gray-400">2024 Dribble. All rights reserved</span>
          
        </div>
        <div className="flex items-center">
          <span className="font-bold text-sm">20,501,853</span>
          <p className="ml-1 text-gray-400 text-sm">shots dribbled</p>
          <FontAwesomeIcon icon={faDribbble} className="ml-2 text-xl text-red-700"/>
        </div>
      </div>
    </div>
  );
...
function Subheading({ subheading }: subheadingprops) {
  return (
    <div className="font-semibold mt-3 text-xs">
      {subheading}
    </div>
  )
}
